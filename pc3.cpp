...
string goldilocks (string item, int number)
{
	...
	if (item == "porridge"){
	    if (number == 1){
	        msg = "This porridge is too hot";
	    } else if (number == 2){
	        msg = "This porridge is too cold";
	    } else {
	        msg = "This porridge is just right";
	    }
	} else if (item == "chair"){
	    if (number == 1){
	        msg = "This chair is too big";
	    } else if (number == 2){
	        msg = "This chair is too big";
	    } else {
	        msg = "This chair is just right";
	    }
	} else {
	    if (number == 1){
	        msg = "This bed is too hard";
	    } else if (number == 2){
	        msg = "This bed is too soft";
	    } else {
	        msg = "This bed is just right";
	    }
	}
